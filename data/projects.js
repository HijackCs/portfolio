export const projects = [

  {
    ...
    context: "Des artisans locaux ont besoin d'un site simple et crédible pour être visibles à Lens et alentour.",
    objective: "Proposer un template vitrine réutilisable, rapide à déployer et orienté conversion.",
    solution: "Un site vitrine modulable avec pages clés, appels à l'action et structure SEO locale.",
    qualitativeResults: "Un parcours de contact plus clair et une base solide pour décliner par métier.",
    keywords: ["site vitrine", "SEO local", "conversion", "artisans", "Lens"],
...
Le template sert de base pour mon offre standard et est facilement personnalisable (couleurs, contenus, images, zone d'intervention) afin de s'adapter à chaque métier.`,
  ...
  },
  {
    ...
    context: "Besoin d'une plateforme interne fiable pour centraliser les processus métier.",
    objective: "Réduire les tâches manuelles et sécuriser la gestion des données.",
    solution: "Une application web complète avec API, tableaux de bord et workflows automatisés.",
    qualitativeResults: "Processus stabilisés, visibilité accrue et meilleure collaboration des équipes.",
    keywords: ["application web", "back-office", "productivité", "automatisation", "sécurité"],
...
Le backend Symfony assure la robustesse et la sécurité des données, avec une architecture MVC claire et des API REST documentées. L'intégration avec PostgreSQL permet une gestion efficace des données volumineuses.`,
  ...
  },
  {
    ...
    context: "Besoin d'un outil mobile pour mieux gérer les repas, les stocks et les recettes.",
    objective: "Simplifier la planification et réduire le gaspillage alimentaire.",
    solution: "Application Android connectée à une API sécurisée avec gestion de profils et de préférences.",
    qualitativeResults: "Meilleure organisation quotidienne et expérience mobile plus fluide.",
    keywords: ["application mobile", "API REST", "gestion de stock", "UX", "sécurité"],
  ...
  },
  {
    ...
    objective: "Améliorer la visibilité, la crédibilité et la prise de contact.",
    solution: "Un site Nuxt.js rapide, animé et structuré pour le SEO.",
    qualitativeResults: "Image de marque renforcée et navigation plus engageante.",
    keywords: ["portfolio", "site vitrine", "performance", "SEO", "Nuxt.js"],
...
L'optimisation SEO et les performances garantissent une excellente visibilité et expérience utilisateur.`,
  ...
  },
  {
    ...
    context: "Suivi manuel des heures et erreurs de calcul récurrentes.",
    objective: "Automatiser la saisie et fiabiliser le calcul du bonus/malus.",
    solution: "Application web légère avec historique, calculs automatiques et stockage local.",
    qualitativeResults: "Processus de saisie plus rapide et moins d'erreurs.",
    keywords: ["outil interne", "automatisation", "productivité", "application web", "UX"],
...
Les données sont stockées localement pour garantir la confidentialité et permettre un fonctionnement hors ligne.`,
  ...
  },
  {
    ...
    objective: "Valider la faisabilité technique et les performances de Quasar.",
    solution: "Un POC complet avec composants, builds et tests multi-plateformes.",
    qualitativeResults: "Documentation interne et base réutilisable pour de futurs projets.",
    keywords: ["POC", "Quasar", "multi-plateforme", "performance", "architecture"],
...
Il a été réalisé dans le cadre de mon master, le but était de mettre en avant une technologie peu connue et de montrer ses avantages par rapport aux autres frameworks.`,
  ...
  
  {
    ...
    context: "Centraliser la gestion d'une maison connectée avec des capteurs hétérogènes.",
    objective: "Améliorer le confort et réduire la consommation énergétique.",
    solution: "Un hub Raspberry Pi avec Home Assistant, Zigbee et automatisations avancées.",
    qualitativeResults: "Suivi en temps réel et scénarios fiables au quotidien.",
    keywords: ["IoT", "domotique", "automatisation", "dashboard", "sécurité"],
